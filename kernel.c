 ...
 ***********************************************************************************************************************/
uint8_t SCH_Add_Task(void (*pTask)(void), const uint32_t Delay, const uint16_t Period)
{
 ...
 * @brief    设置系统滴答
 ***********************************************************************************************************************/
void systick_tick_set(uint32_t tick)
{
    system_tick = tick;
}
...
/***********************************************************************************************************************
* @brief    功能函数3，300ms运行周期
***********************************************************************************************************************/
void fun3_300ms(void)
{
...
int main( int argc, char *argv[] )
{
    ...
    SCH_Init();
    SCH_Add_Task(fun1_100ms,0,100);
    SCH_Add_Task(fun2_200ms,3,200);
    SCH_Add_Task(fun3_300ms,5,300);
